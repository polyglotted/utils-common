...
public final class GeoHash {
    ...
    @NonNull public final GeoPoint point;

    @Override
    public boolean equals(Object o) { return this == o || o != null && getClass() == o.getClass() && point.equals(((GeoHash) o).point); }

    @Override
    public int hashCode() { return Objects.hash(point); }

    @Override
    public String toString() { return encodeGeoHash(point.lat, point.lon); }
    ...
    public static GeoHash decodeGeoHash(String geohash) {
        ...
        return new GeoHash(new GeoPoint(decode(latset, -90, 90), decode(lonset, -180, 180)));
    }
